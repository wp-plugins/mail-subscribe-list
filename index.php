                    ...
                    <div class="meta-box-sortables">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <p class="voucher" style="background:#21759B; border-radius: 5px; padding:10px; text-align:center; color:#FFF; line-height:15px;"><strong style="font-size:16px">50% OFF ALL<br />WordPress Hosting Packages</strong><br />Your Coupon Code:<strong style="font-size:32px; background:#FFF; color:#21759B; line-height: 38px; display:block; padding: 2px 0">2YH6EJIN4Z</strong>Discount can be applied on Checkout<a class="button" href="http://www.webfwd.co.uk/packages/wordpress-hosting/" target="_blank">Click Here to Purchase</a></p>
